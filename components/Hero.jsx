        ...
        >
            ...
            <div className="container z-10 max-w-screen-lg mx-auto h-full flex flex-col">
                <div className="hero-logo flex items-center">
                    <h1 className='sr-only'>Becas del Uruguay, alcanza tus metas educativas</h1>
                    <Image
                ...
                <div className="hero-text flex flex-col gap-2 mx-5 xl:mx-0">
                    ...
                    <p className="text-sm md:w-2/3 2xl:text-lg">
                        Este es un sitio donde puedes buscar y encontrar
                        becas que se ajusten a tus necesidades y objetivos académicos.
                        Ofrecemos una amplia variedad de becas en diferentes campos
                        y niveles de estudio. Nuestro objetivo es ayudarte a alcanzar
                        tus metas educativas sin la preocupación financiera.
                    </p>
                </div>
